...
//       const spares = spareEntry.products.map((item: any): Spare => ({
//         _id: item._id,
...
//     const part = books.find((p) => p.product_id === product_id);
//     if (part) {
...
//     setBooks((prev) => prev.filter((p) => p.product_id !== id));
...
//                       <SparePartCard key={part.product_id} part={part} />
//                     ))}
//                   </div>
//                 ) : (
...
//     // <div className="min-h-screen p-6 bg-gray-100" style={{ backgroundImage: `url("${bgImage}")` }}>
//     //   <div className="max-w-7xl mx-auto">
//     //     <h1 className="text-3xl font-bold mb-6 text-[#9b111e]">My Cart</h1>

//     //     {/* Tab Toggle */}
//     //     <div className="inline-flex p-1 bg-[#FAF3EB] border rounded-full mb-6">
//     //       <button onClick={() => setActiveTab("service")} className={`px-6 py-2 rounded-full ${activeTab === "service" ? "bg-[#9b111e] text-white" : "text-black"}`}>
//     //         <Wrench /> SparePart Orders
//     //       </button>
//     //       <button onClick={() => setActiveTab("ServiceBookingPage")} className={`px-6 py-2 rounded-full ${activeTab === "ServiceBookingPage" ? "bg-[#9b111e] text-white" : "text-black"}`}>
//     //         <Car /> Service Orders
//     //       </button>
//     //     </div>
...
//     //         ) : filteredParts.length > 0 ? (
//     //           filteredParts.map((part) => <SparePartCard key={part.product_id} part={part} />)
//     //         ) : (
...
//     //     {/* Summary */}
//     //     {(showSummary || showsSummary) && (
//     //       <div className="bg-white shadow-md rounded-lg p-6 mt-8">
//     //         <h2 className="text-xl font-bold mb-4">Order Summary</h2>
//     //         {confirmedPartOrders.map(({ part, quantity }) => (
//     //           <div key={part.product_id} className="flex justify-between text-sm">
//     //             <span>{part.product_name} x {quantity}</span>
//     //             <span>₹{part.price * quantity}</span>
//     //           </div>
//     //         ))}
//     //         {confirmedServiceOrders.map(({ serv, quantity }) => (
//     //           <div key={serv.id} className="flex justify-between text-sm">
//     //             <span>{serv.name} x {quantity}</span>
//     //             <span>₹{serv.price * quantity}</span>
//     //           </div>
//     //         ))}
//     //         <div className="border-t mt-4 pt-2 flex justify-between font-bold">
//     //           <span>Total</span>
//     //           <span>₹{totalPartPrice + totalServicePrice}</span>
//     //         </div>
//     //         <button
//     //           className="mt-4 px-6 py-2 bg-[#9b111e] text-white rounded-full hover:bg-red-700 transition"
//     //           onClick={() => toast("Order Confirmed 🎉", { autoClose: 1000 })}
//     //         >
//     //           Place Order
//     //         </button>
//     //       </div>
