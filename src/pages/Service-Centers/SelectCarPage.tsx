...
const SelectCarPage: React.FC<SelectCarPageProps> = ({ onClose }) => {
    ...
    const carData = {
        Honda: {
            models: ['Civic', 'Accord', 'CR-V', 'Pilot', 'Fit', 'HR-V', 'Passport', 'Ridgeline'],
        ...
        Ford: {
            models: ['F-150', 'Mustang', 'Explorer', 'Escape', 'Focus', 'Fusion', 'Edge', 'Bronco'],
            years: [2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015],
            fuels: ['Petrol', 'Diesel', 'Electric']
        },
        BMW: {
            models: ['3 Series', '5 Series', '7 Series', 'X3', 'X5', 'X7', 'Z4', 'i4'],
            years: [2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015],
            fuels: ['Petrol', 'Diesel', 'Electric', 'Hybrid']
        },
        Mercedes: {
            models: ['C-Class', 'E-Class', 'S-Class', 'GLC', 'GLE', 'GLS', 'A-Class', 'CLA'],
            years: [2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015],
            fuels: ['Petrol', 'Diesel', 'Electric', 'Hybrid']
        },
        Audi: {
    ...
    const getAvailableModels = () => {
        return selectedCar.brand ? carData[selectedCar.brand as keyof typeof carData]?.models || [] : [];
    };
