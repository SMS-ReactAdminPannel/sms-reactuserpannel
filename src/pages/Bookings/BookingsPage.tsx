...
const OrderCard: React.FC<OrderCardProps> = ({ order }) => {
	...
	const isOld =
		orderDate && orderDate < new Date(Date.now() - 365 * 24 * 60 * 60 * 1000);
				...
				<div className='bg-red-50 text-red-900 px-4 py-4 border-t border-red-200 transition-all duration-300 text-sm mt-2'>
					...
					<div className='flex flex-row justify-between items-start gap-6'>
						...
						<div className='w-1/2 space-y-2'>
							<p>
								<strong>
									Compatibility <span className='ml-4'>:</span>{' '}
								</strong>
								<span className='ml-8'>{order.compatibility}</span>
							</p>
							<p>
								<strong>
									Original Price<span className='ml-4'>:</span>
								</strong>{' '}
							...
							<p>
								<strong>
									Final Price<span className='ml-9'>:</span>
								</strong>{' '}
							...
							<p>
								<strong>
									You Saved<span className='ml-9'>:</span>
								</strong>{' '}
								<span className='text-green-600 font-medium ml-9'>
									₹{order.discount} (
									{Math.round((order.discount / order.price) * 100)}% OFF)
								</span>
							</p>
						</div>
						...
						<div className='w-1/2 space-y-2 border border-dashed border-red-300 rounded-lg p-4 bg-red-100 text-sm'>
							...
							<div className='flex items-start'>
								...
								<p>
									<span className='mr-4'>:</span> {order.status}{' '}
								</p>
							</div>
							...
							<div className='flex items-start'>
								...
								<p>
									<span className='mr-4'>:</span> {order.update}
								</p>
							</div>
						</div>
					</div>
					...
					<div className='flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between'>
						...
						<div className='relative flex-1 max-w-md'>
							...
							<input
								...
								className='w-[330px] pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all'
							/>
						</div>
						...
						<div className='flex flex-wrap gap-3'>
							...
							<button
								...
								className='px-6 py-2 bg-red-700 text-white rounded-xl hover:bg-red-800 transition-all duration-200 shadow-sm hover:shadow-md font-medium text-sm'
							>
								Reset Filters
							</button>
						</div>
