...
const OrderDetails: React.FC<OrderDetailsProps> = ({ part }) => {
  ...
  return (
    <div className="group relative">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-[0_0_20px_#f87171] hover:border hover:border-red-300 transition-all duration-300 overflow-hidden">
        {/* Status Badge */}
